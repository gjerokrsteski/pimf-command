...
return array(
  ...
  */
  'app' => array(
    ...
    'default_controller' => 'account', // the name of the fallback controller
  ...
  */
  'session' => array(
      ...
      'storage_path' => 'app/Command/_session/',

      // If using the PDO (database) session storage
      'database' => array(
        //'driver' => 'sqlite',
        //'database' => 'app/Command/_session/session.db',
      ),
  ...
  */
  'cache' => array(
      ...
      // If using file storage - default is null
      'storage_path' => 'app/Command/_cache/',

      // If using the PDO (database) cache storage
      'database' => array(
        //'driver' => 'sqlite',
        //'database' => 'app/Command/_cache/cache.db',
      ),
